import{s as Z,n as Ae,t as ke,L as V,d as De,a as ee,b as w,C as Ne,c as ze,h as He,e as j,f as te,g as K,l as qe,i as ue,j as Ge,M as Ve,r as We,k as je,m as Q,p as Ke,u as ce,q as Ye,o as Xe,v as Je,A as Qe,w as Ze,x as he,y as et,_ as _e,z as tt,B as it,D as rt,E as Y,F as st,G as fe,H as nt,I as at}from"./index-989909ce.js";import{s as ot,C as lt,b as dt,e as pe,r as ut,t as ct,a as ht,m as _t,Y as ft,n as pt,c as mt,d as gt}from"./MagnifierPrograms-1899ec83.js";import{u as Ps,y as Cs}from"./MagnifierPrograms-1899ec83.js";import{o as vt}from"./imageutils-488e927b.js";import{t as bt,i as wt,o as me,h as ge,a as xt}from"./Container-d6a11296.js";import{i as yt}from"./BufferPool-c9355ed2.js";import{T as M,E as C,S as $}from"./color-e690ede3.js";import{t as Tt,n as k,a as q,b as ie,w as A,c as Ft,m as Bt}from"./WGLContainer-20e8cdd8.js";import{L as B}from"./enums-fb086c25.js";import{e as Ot,a as W}from"./ProgramTemplate-9e2e5761.js";import{n as U}from"./programUtils-362e0fcb.js";import{u as re,c as se,x as P,s as Et}from"./VertexArrayObject-de8d8d6a.js";import{R as g,E as H,F as ne,O as X,I as ae,L as D,C as ve,D as O,B as oe,G as T,U as le,P as Rt}from"./enums-b14466b3.js";import{o as be,P as Mt}from"./RenderingContext-11ad6479.js";import{j as Pt,b as Ct,N as St,B as At,C as Dt,I as N,J as zt,Y as Ie,O as we}from"./definitions-c7b3085f.js";import{t as xe}from"./VertexElementDescriptor-2925c6af.js";import{a as E,u as L}from"./Texture-501dc2a6.js";import{e as It}from"./imageUtils-c2d0d1ae.js";import{o as As}from"./GraphicsView2D-557a8e65.js";import{i as zs}from"./GraphicContainer-fc5edfeb.js";import{t as ye}from"./requestImageUtils-074a1958.js";import"./ExpandedCIM-d2c7e7d5.js";import"./BidiEngine-9a40f2f4.js";import"./GeometryUtils-53652037.js";import"./enums-55085e26.js";import"./GeometryUtils-84a108d1.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-611ec4df.js";import"./floatRGBA-5f0a804f.js";import"./rasterizingUtils-e480e08c.js";import"./pbf-f1321473.js";import"./Matcher-d0713c3f.js";import"./visualVariablesUtils-0f51e147.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-456f79c5.js";import"./featureConversionUtils-b1362163.js";import"./OptimizedGeometry-33b2eb0d.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./defaultsJSON-b087dd4d.js";import"./earcut-27e6c8d6.js";import"./LRUCache-a1ffc3d4.js";import"./devEnvironmentUtils-5002a058.js";import"./styleUtils-ee1316c2.js";import"./featureFlags-8ed38c32.js";import"./webStyleSymbolUtils-2ed84a40.js";import"./CircularArray-ef508845.js";import"./DisjointTimerQuery-bcdafcd7.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-2e595e38.js";import"./FieldsIndex-958df084.js";import"./arcadeTimeUtils-5c44bb6d.js";import"./executionError-c92d3b85.js";import"./projectionSupport-f9da330e.js";import"./json-48e3ea08.js";import"./diffUtils-a4f61c8a.js";import"./lengthUtils-32b5157c.js";import"./sizeVariableUtils-d4870b0d.js";import"./parser-39b32429.js";import"./AttributeStoreView-d6656c7a.js";import"./TiledDisplayObject-cb1d7c8b.js";import"./sql-926e6229.js";import"./labelingInfo-3941dab0.js";import"./labelUtils-f745c070.js";import"./clusterUtils-34d60035.js";import"./SizeVariable-3a3f0b31.js";import"./colorRamps-c86b1339.js";import"./LegendOptions-3ac5ff0b.js";import"./util-af5beedd.js";import"./heatmapUtils-8adef46d.js";import"./vec4f64-aa64c7e9.js";import"./StyleDefinition-fbc907c2.js";import"./config-1337d16e.js";import"./NestedMap-1b5db22e.js";import"./OrderIndependentTransparency-309a1bc3.js";import"./basicInterfaces-4ab7cc6a.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-132c0a94.js";import"./normalizeUtilsCommon-8a86e794.js";import"./normalizeUtils-938fb227.js";import"./BaseGraphicContainer-efdff444.js";import"./FeatureContainer-9a5fe42d.js";import"./TileContainer-49ce0aaa.js";import"./vec3f32-ad1dc57f.js";async function Ut(l,e){const t=ot(l);if(t instanceof Error)throw t;await t.createImages(),Z(e);const{frames:i,width:r,height:n}=t,s=document.createElement("canvas");s.width=r,s.height=n;const a=s.getContext("2d",{willReadFrequently:!0}),d=[],u=[];for(const o of i){u.push(Ae(o.delay||100));const c=o.imageElement;o.blendOp===0?a.globalCompositeOperation="copy":a.globalCompositeOperation="source-over";const h=o.disposeOp===2?a.getImageData(o.left,o.top,o.width,o.height):void 0;a.drawImage(c,o.left,o.top);const f=a.getImageData(0,0,r,n);d.push(f),o.disposeOp===0||(o.disposeOp===1?a.clearRect(o.left,o.top,o.width,o.height):o.disposeOp===2&&a.putImageData(h,o.left,o.top))}return{frameDurations:u,getFrame:o=>d[o],width:r,height:n}}const $t=[137,80,78,71,13,10,26,10];function Lt(l){const e=new Uint8Array(l);return!$t.some((t,i)=>t!==e[i])}function kt(l){if(!Lt(l))return!1;const e=new DataView(l),t=new Uint8Array(l);let i,r=8;do{const n=e.getUint32(r);if(i=String.fromCharCode.apply(String,Array.prototype.slice.call(t.subarray(r+4,r+8))),i==="acTL")return!0;r+=12+n}while(i!=="IEND"&&r<t.length);return!1}async function Nt(l,e){const t=lt(l),i=dt(t,!0),{width:r,height:n}=t.lsd,s=document.createElement("canvas");s.width=r,s.height=n;const a=s.getContext("2d",{willReadFrequently:!0}),d=[],u=[];for(const o of i){u.push(Ae(o.delay||100));const c=new ImageData(o.patch,o.dims.width,o.dims.height),h=vt(c),f=o.disposalType===3?a.getImageData(o.dims.left,o.dims.top,o.dims.width,o.dims.height):void 0;a.drawImage(h,o.dims.left,o.dims.top);const p=a.getImageData(0,0,r,n);d.push(p),o.disposalType===1||(o.disposalType===2?a.clearRect(o.dims.left,o.dims.top,o.dims.width,o.dims.height):o.disposalType===3&&a.putImageData(f,o.dims.left,o.dims.top))}return{frameDurations:u,getFrame:o=>d[o],width:r,height:n}}const Ht=[71,73,70];function qt(l){const e=new Uint8Array(l);return!Ht.some((t,i)=>t!==e[i])}function Gt(l){if(!qt(l))return!1;const e=new DataView(l),t=e.getUint8(10);let i=13+(128&t?3*2**(1+(7&t)):0),r=0,n=!1;for(;!n;){switch(e.getUint8(i++)){case 33:if(!s())return!1;break;case 44:a();break;case 59:n=!0;break;default:return!1}if(r>1)return!0}function s(){switch(e.getUint8(i++)){case 249:d();break;case 1:u();break;case 254:o();break;case 255:c();break;default:return!1}return!0}function a(){r++,i+=8;const f=e.getUint8(i++);i+=128&f?3*2**(1+(7&f)):0,i++,h()}function d(){i++,i+=4,h()}function u(){r++,i++,i+=12,h()}function o(){h()}function c(){i++,i+=8,i+=3,h()}function h(){let f;for(;f=e.getUint8(i++);)i+=f}return!1}let Vt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=jt(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}};async function Wt(l,e){const t=window.URL.createObjectURL(l);try{const{data:i}=await V(t,{...e,responseType:"image"});return i}catch(i){throw De(i)?i:new ee("mapview-invalid-resource",`Could not fetch requested resource at ${t}`)}finally{window.URL.revokeObjectURL(t)}}async function jt(l,e){const{arrayBuffer:t,mediaType:i}=await Kt(l,e),r=i==="image/png";return i==="image/gif"&&Gt(t)?Nt(t):r&&kt(t)?Ut(t,e):Wt(new Blob([t],{type:i}),e)}async function Kt(l,e){let t;const i=";base64,";if(l.includes(i)){const r=l.indexOf(i),n=l.indexOf(i)+i.length,s=l.substring(n);t={arrayBuffer:ke(s),mediaType:l.substring(0,r).replace("data:","")}}else try{const r=await V(l,{responseType:"array-buffer",...e});t={arrayBuffer:r.data,mediaType:r.getHeader("Content-Type")}}catch(r){if(!De(r))throw new ee("mapview-invalid-resource",`Could not fetch requested resource at ${l}`)}return t}const Yt={background:{"background.frag":`#ifdef PATTERN
