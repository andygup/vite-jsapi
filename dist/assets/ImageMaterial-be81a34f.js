import{cc as v,ii as m,ij as P,bT as f,cq as c,cd as y,ik as A,il as O,im as $,f as r,e$ as _,io as S,ip as p,cv as C,_ as E,iq as x,ir as g,e as o,cE as n,eS as d,cw as w,cx as b,cy as D,cz as N,is as M,it as R,iu as I,cA as F,iv as L,cB as B,cC as U,iw as z,cD as W,ix as G,cF as j,iy as q,iz as H,E as u,iA as Q,iB as V,iC as k,iD as J}from"./index-d29f6b97.js";function K(a){const e=new v,{vertex:t,fragment:s}=e;return m(t,a),e.include(P,a),e.attributes.add(f.POSITION,"vec3"),e.attributes.add(f.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.code.add(c`
    void main(void) {
      vpos = position;
