import{cc as v,il as m,im as P,bT as f,cq as c,cd as y,io as A,ip as O,iq as $,f as r,e$ as _,ir as S,is as p,cv as E,_ as C,it as x,iu as g,e as o,cE as n,eS as d,cw as w,cx as b,cy as D,cz as N,iv as M,iw as R,ix as I,cA as F,iy as L,cB as B,cC as U,iz as z,cD as G,iA as W,cF as q,iB as H,iC as j,E as u,iD as Q,iE as V,iF as k,iG as J}from"./index-bdad94d1.js";function K(a){const e=new v,{vertex:t,fragment:s}=e;return m(t,a),e.include(P,a),e.attributes.add(f.POSITION,"vec3"),e.attributes.add(f.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.code.add(c`
    void main(void) {
      vpos = position;
