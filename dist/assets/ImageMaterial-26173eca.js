import{cc as v,ij as m,ik as P,bT as f,cq as c,cd as y,il as A,im as O,io as $,f as r,e$ as _,ip as S,iq as p,cv as E,_ as C,ir as x,is as g,e as o,cE as n,eS as d,cw as w,cx as b,cy as D,cz as N,it as M,iu as R,iv as I,cA as F,iw as L,cB as B,cC as U,ix as z,cD as W,iy as G,cF as j,iz as q,iA as H,E as u,iB as Q,iC as V,iD as k,iE as J}from"./index-0b6846a6.js";function K(a){const e=new v,{vertex:t,fragment:s}=e;return m(t,a),e.include(P,a),e.attributes.add(f.POSITION,"vec3"),e.attributes.add(f.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.code.add(c`
    void main(void) {
      vpos = position;
