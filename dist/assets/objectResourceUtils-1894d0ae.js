...
precision highp sampler2D;`,Yt=4;function Ls(){const t=new Ut,e=t.fragment;t.include(to);const r=(Yt+1)/2,i=1/(2*r*r);return e.include(yr),e.uniforms.add([new Z("depthMap",o=>o.depthTexture),new ut("tex",o=>o.colorTexture),new Cs("blurSize",o=>o.blurSize),new ee("projScale",(o,a)=>{const n=qo(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,o.projScale-(n-5e4)):o.projScale}),new ye("nearFar",(o,a)=>a.camera.nearFar)]),e.code.add(s`
  ...
  `),t}const $s=Object.freeze(Object.defineProperty({__proto__:null,build:Ls},Symbol.toStringTag,{value:"Module"}));let Is=class ao extends br{initializeProgram(e){return new Sr(e.rctx,ao.shader.get().build(),Bt)}initializePipeline(){return fr({colorWrite:vr})}};Is.shader=new zt($s,()=>vt(()=>import("./SSAOBlur.glsl-e175e2fa.js"),["assets/SSAOBlur.glsl-e175e2fa.js","assets/index-fb13df2f.js","assets/index-d832a396.css","assets/OrderIndependentTransparency-5206b14a.js","assets/enums-10aa9b05.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/BufferView-dec1102b.js","assets/vec32-a8b0e3a5.js","assets/DefaultMaterial_COLOR_GAMMA-70fcf63d.js","assets/Version-1861d2e1.js","assets/resourceUtils-1d112ccb.js","assets/Indices-50c09fc6.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-4b82835b.js","assets/InterleavedLayout-93752cf7.js","assets/types-1305598a.js","assets/Texture-05984be5.js","assets/VertexArrayObject-01ae6462.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-f509cd06.js","assets/VertexElementDescriptor-2925c6af.js"]));function Ns(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>Ds(r))),t.fragment.uniforms.add(new ye("zScale",(e,r)=>no(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
