...
precision highp sampler2D;`,Qt=4;function Ps(){const t=new Gt,e=t.fragment;t.include(to);const r=(Qt+1)/2,i=1/(2*r*r);return e.include(yr),e.uniforms.add([new Z("depthMap",o=>o.depthTexture),new ut("tex",o=>o.colorTexture),new ys("blurSize",o=>o.blurSize),new ee("projScale",(o,a)=>{const n=jo(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,o.projScale-(n-5e4)):o.projScale}),new ye("nearFar",(o,a)=>a.camera.nearFar)]),e.code.add(s`
  ...
  `),t}const Ls=Object.freeze(Object.defineProperty({__proto__:null,build:Ps},Symbol.toStringTag,{value:"Module"}));let $s=class ao extends br{initializeProgram(e){return new Sr(e.rctx,ao.shader.get().build(),zt)}initializePipeline(){return fr({colorWrite:vr})}};$s.shader=new Ut(Ls,()=>vt(()=>import("./SSAOBlur.glsl-e9d1e6cb.js"),["assets/SSAOBlur.glsl-e9d1e6cb.js","assets/index-9f03d686.js","assets/index-d832a396.css","assets/OrderIndependentTransparency-5b5adc11.js","assets/enums-74e97557.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/BufferView-595f5888.js","assets/vec32-59ce53ff.js","assets/DefaultMaterial_COLOR_GAMMA-5a120fb4.js","assets/Version-893a3a85.js","assets/resourceUtils-1d112ccb.js","assets/Indices-d3b80329.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-8c2fa7ec.js","assets/InterleavedLayout-fb145064.js","assets/types-1305598a.js","assets/Texture-43db1794.js","assets/VertexArrayObject-a9648fde.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-30258353.js","assets/VertexElementDescriptor-2925c6af.js"]));function Is(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>Ns(r))),t.fragment.uniforms.add(new ye("zScale",(e,r)=>no(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
