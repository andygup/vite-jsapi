...
precision highp sampler2D;`,Qt=4;function zs(){const t=new Ht,e=t.fragment;t.include(ao);const r=(Qt+1)/2,i=1/(2*r*r);return e.include(yr),e.uniforms.add(new Z("depthMap",o=>o.depthTexture),new ht("tex",o=>o.colorTexture),new Ls("blurSize",o=>o.blurSize),new ee("projScale",(o,a)=>{const n=qo(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,o.projScale-(n-5e4)):o.projScale}),new ye("nearFar",(o,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Bs=Object.freeze(Object.defineProperty({__proto__:null,build:zs},Symbol.toStringTag,{value:"Module"}));let Us=class co extends br{initializeProgram(e){return new Sr(e.rctx,co.shader.get().build(),Bt)}initializePipeline(){return fr({colorWrite:pr})}};Us.shader=new Ut(Bs,()=>gt(()=>import("./SSAOBlur.glsl-45f47c3c.js"),["assets/SSAOBlur.glsl-45f47c3c.js","assets/index-6e11f365.js","assets/index-001d3307.css","assets/OrderIndependentTransparency-5b5adc11.js","assets/enums-74e97557.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-a390d1f0.js","assets/vec32-4cb72563.js","assets/DefaultMaterial_COLOR_GAMMA-81f163a9.js","assets/Version-6c5d6273.js","assets/quat-e14f7ae2.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-cff23aed.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-9e3fcc9a.js","assets/InterleavedLayout-69c6fbf1.js","assets/types-1305598a.js","assets/vec4f64-aa64c7e9.js","assets/sphere-3b0c51ee.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-e306ae93.js","assets/TextureDescriptor-6f1ebf7c.js","assets/VertexArrayObject-0a6bf41d.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-aa0525a8.js","assets/lengthUtils-9743f155.js","assets/VertexElementDescriptor-2925c6af.js"]));function Hs(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>Gs(r))),t.fragment.uniforms.add(new ye("zScale",(e,r)=>uo(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
...
return fallOffFunction(vv, vn, 0.1);
  ...
  `),t}function ho(t){return Math.max(10,20*t.computeRenderPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const oi=fi(),ks=Object.freeze(Object.defineProperty({__proto__:null,build:Ws,getRadius:ho},Symbol.toStringTag,{value:"Module"}));let js=class mo extends br{initializeProgram(e){return new Sr(e.rctx,mo.shader.get().build(),Bt)}initializePipeline(){return fr({colorWrite:pr})}};js.shader=new Ut(ks,()=>gt(()=>import("./SSAO.glsl-83b53105.js"),["assets/SSAO.glsl-83b53105.js","assets/index-6e11f365.js","assets/index-001d3307.css","assets/OrderIndependentTransparency-5b5adc11.js","assets/enums-74e97557.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/vec4f64-aa64c7e9.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-a390d1f0.js","assets/vec32-4cb72563.js","assets/DefaultMaterial_COLOR_GAMMA-81f163a9.js","assets/Version-6c5d6273.js","assets/quat-e14f7ae2.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-cff23aed.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-9e3fcc9a.js","assets/InterleavedLayout-69c6fbf1.js","assets/types-1305598a.js","assets/sphere-3b0c51ee.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-e306ae93.js","assets/TextureDescriptor-6f1ebf7c.js","assets/VertexArrayObject-0a6bf41d.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-aa0525a8.js","assets/lengthUtils-9743f155.js","assets/VertexElementDescriptor-2925c6af.js"]));const qs=2;function Cr(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(i,o)=>o.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/qs),r.code.add(s`float evaluateAmbientOcclusionInverse() {
