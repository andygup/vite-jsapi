...
return t1 + t2;
}`)}let Ui=class extends J{constructor(e,r){super(e,"mat3",V.Draw,(i,o,a)=>i.setUniformMatrix3fv(e,r(o,a)))}},Re=class extends J{constructor(e,r){super(e,"mat3",V.Pass,(i,o,a)=>i.setUniformMatrix3fv(e,r(o,a)))}},ze=class extends J{constructor(e,r){super(e,"mat4",V.Pass,(i,o,a)=>i.setUniformMatrix4fv(e,r(o,a)))}};function Hi(t,e){t.include(Tr);const r=t.vertex;r.include(Bi,e),t.varyings.add("vPositionWorldCameraRelative","vec3"),t.varyings.add("vPosition_view","vec3"),r.uniforms.add(new Q("transformWorldFromViewTH",i=>i.transformWorldFromViewTH),new Q("transformWorldFromViewTL",i=>i.transformWorldFromViewTL),new Re("transformViewFromCameraRelativeRS",i=>i.transformViewFromCameraRelativeRS),new ze("transformProjFromView",i=>i.transformProjFromView),new Ui("transformWorldFromModelRS",i=>i.transformWorldFromModelRS),new he("transformWorldFromModelTH",i=>i.transformWorldFromModelTH),new he("transformWorldFromModelTL",i=>i.transformWorldFromModelTL)),r.code.add(s`vec3 positionWorldCameraRelative() {
...
}`)):(t.fragment.uniforms.add(new eo("colorMixMode",r=>Hn[r.colorMixMode])),t.vertex.code.add(s`vec4 getSymbolColor() { return vec4(1.0); }
...
color.a = 1.0;
        ...
        `);break;case A.Normal:{ft(r,e),t.include(mt,e),t.include(zt,e),t.include(Gi,e),t.include(qe,e),t.include(pt,e),a&&i.uniforms.add(new Z("tex",c=>c.texture)),e.normalType===B.ScreenDerivative&&t.varyings.add("vPositionView","vec3");const n=e.normalType===B.Attribute||e.normalType===B.Compressed;r.code.add(s`
          void main(void) {
            vpos = calculateVPos();
...
precision highp sampler2D;`,Qt=4;function zs(){const t=new Ht,e=t.fragment;t.include(ao);const r=(Qt+1)/2,i=1/(2*r*r);return e.include(yr),e.uniforms.add(new Z("depthMap",o=>o.depthTexture),new ht("tex",o=>o.colorTexture),new Ls("blurSize",o=>o.blurSize),new ee("projScale",(o,a)=>{const n=qo(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,o.projScale-(n-5e4)):o.projScale}),new ye("nearFar",(o,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Bs=Object.freeze(Object.defineProperty({__proto__:null,build:zs},Symbol.toStringTag,{value:"Module"}));let Us=class co extends br{initializeProgram(e){return new Sr(e.rctx,co.shader.get().build(),Bt)}initializePipeline(){return fr({colorWrite:pr})}};Us.shader=new Ut(Bs,()=>gt(()=>import("./SSAOBlur.glsl-8bf077c3.js"),["assets/SSAOBlur.glsl-8bf077c3.js","assets/index-298039cc.js","assets/index-001d3307.css","assets/OrderIndependentTransparency-5b5adc11.js","assets/enums-74e97557.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-4066ca01.js","assets/vec32-44169d99.js","assets/DefaultMaterial_COLOR_GAMMA-2c022b91.js","assets/Version-67fba075.js","assets/quat-a2fc42ab.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-8de1e802.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-1f33e3fb.js","assets/InterleavedLayout-19f27504.js","assets/types-1305598a.js","assets/vec4f64-aa64c7e9.js","assets/sphere-22662532.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-de9db946.js","assets/TextureDescriptor-5435dd8f.js","assets/VertexArrayObject-3b90f4d9.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-ffd7b24a.js","assets/lengthUtils-f797b468.js","assets/VertexElementDescriptor-2925c6af.js"]));function Hs(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>Gs(r))),t.fragment.uniforms.add(new ye("zScale",(e,r)=>uo(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
return vec3((fragCoord * projInfo.xy + projInfo.zw) * (zScale.x * depth + zScale.y), depth);
}`)}function Gs(t){const e=t.camera.projectionMatrix;return e[11]===0?ie(ti,2/(t.camera.fullWidth*e[0]),2/(t.camera.fullHeight*e[5]),(1+e[12])/e[0],(1+e[13])/e[5]):ie(ti,-2/(t.camera.fullWidth*e[0]),-2/(t.camera.fullHeight*e[5]),(1-e[8])/e[0],(1-e[9])/e[5])}const ti=Vt();function uo(t){return t.camera.projectionMatrix[11]===0?Mt(ri,0,1):Mt(ri,1,0)}const ri=fi(),ii=16;function Ws(){const t=new Ht,e=t.fragment;return t.include(ao),e.include(yr),t.include(Hs),e.uniforms.add(new ee("radius",(r,i)=>ho(i.camera))),e.code.add(s`vec3 sphere[16];
void fillSphere() {
...
return fallOffFunction(vv, vn, 0.1);
  ...
  `),t}function ho(t){return Math.max(10,20*t.computeRenderPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const oi=fi(),ks=Object.freeze(Object.defineProperty({__proto__:null,build:Ws,getRadius:ho},Symbol.toStringTag,{value:"Module"}));let js=class mo extends br{initializeProgram(e){return new Sr(e.rctx,mo.shader.get().build(),Bt)}initializePipeline(){return fr({colorWrite:pr})}};js.shader=new Ut(ks,()=>gt(()=>import("./SSAO.glsl-44d5fb66.js"),["assets/SSAO.glsl-44d5fb66.js","assets/index-298039cc.js","assets/index-001d3307.css","assets/OrderIndependentTransparency-5b5adc11.js","assets/enums-74e97557.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/vec4f64-aa64c7e9.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-4066ca01.js","assets/vec32-44169d99.js","assets/DefaultMaterial_COLOR_GAMMA-2c022b91.js","assets/Version-67fba075.js","assets/quat-a2fc42ab.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-8de1e802.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-1f33e3fb.js","assets/InterleavedLayout-19f27504.js","assets/types-1305598a.js","assets/sphere-22662532.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-de9db946.js","assets/TextureDescriptor-5435dd8f.js","assets/VertexArrayObject-3b90f4d9.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-ffd7b24a.js","assets/lengthUtils-f797b468.js","assets/VertexElementDescriptor-2925c6af.js"]));const qs=2;function Cr(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(i,o)=>o.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/qs),r.code.add(s`float evaluateAmbientOcclusionInverse() {
...
}`))}const ai=$(),xe=Vt();function Or(t){t.uniforms.add(new Q("mainLightDirection",(e,r)=>r.lighting.mainLight.direction))}function Gt(t){t.uniforms.add(new Q("mainLightIntensity",(e,r)=>r.lighting.mainLight.intensity))}function ni(t){Or(t.fragment),Gt(t.fragment),t.fragment.code.add(s`vec3 evaluateMainLighting(vec3 normal_global, float shadowing) {
...
return max(c.x, max(c.y, c.z));
  ...
  `)}function nl(t){const e=new Ht,{vertex:r,fragment:i,varyings:o}=e;if(ft(r,t),e.include(Tr),o.add("vpos","vec3"),e.include(pt,t),e.include(Ki,t),e.include(io,t),t.hasColorTextureTransform&&e.include(el),t.output===A.Color||t.output===A.Alpha){t.hasNormalTextureTransform&&e.include(tl),t.hasEmissionTextureTransform&&e.include(rl),t.hasOcclusionTextureTransform&&e.include(il),t.hasMetallicRoughnessTextureTransform&&e.include(ol),vt(r,t),e.include(zt,t),e.include(mt,t);const a=t.normalType===B.Attribute||t.normalType===B.Compressed;a&&t.offsetBackfaces&&e.include(qi),e.include(Ps,t),e.include(Gi,t),t.instancedColor&&e.attributes.add(h.INSTANCECOLOR,"vec4"),o.add("vPositionLocal","vec3"),e.include(qe,t),e.include(ji,t),e.include(to,t),e.include(ro,t),r.uniforms.add(new te("externalColor",n=>n.externalColor)),o.add("vcolorExt","vec4"),t.hasMultipassTerrain&&o.add("depth","float"),t.hasModelTransformation&&r.uniforms.add(new ze("model",n=>n.modelTransformation!=null?n.modelTransformation:Rt)),r.code.add(s`
      void main(void) {
