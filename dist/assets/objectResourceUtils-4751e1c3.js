...
precision highp sampler2D;`,Qt=4;function zs(){const t=new Gt,e=t.fragment;t.include(ao);const r=(Qt+1)/2,i=1/(2*r*r);return e.include(yr),e.uniforms.add(new Z("depthMap",o=>o.depthTexture),new ht("tex",o=>o.colorTexture),new Ls("blurSize",o=>o.blurSize),new ee("projScale",(o,a)=>{const n=qo(a.camera.eye,a.camera.center);return n>5e4?Math.max(0,o.projScale-(n-5e4)):o.projScale}),new ye("nearFar",(o,a)=>a.camera.nearFar)),e.code.add(s`
  ...
  `),t}const Bs=Object.freeze(Object.defineProperty({__proto__:null,build:zs},Symbol.toStringTag,{value:"Module"}));let Us=class co extends br{initializeProgram(e){return new Sr(e.rctx,co.shader.get().build(),Bt)}initializePipeline(){return fr({colorWrite:pr})}};Us.shader=new Ut(Bs,()=>gt(()=>import("./SSAOBlur.glsl-0bf7b7b0.js"),["assets/SSAOBlur.glsl-0bf7b7b0.js","assets/index-989909ce.js","assets/index-0492b785.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-d0acf3a4.js","assets/vec32-c2909e9e.js","assets/DefaultMaterial_COLOR_GAMMA-302922de.js","assets/Version-f874365f.js","assets/quat-6714c1ef.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-91be4389.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-074a1958.js","assets/InterleavedLayout-1faa6139.js","assets/types-1305598a.js","assets/vec4f64-aa64c7e9.js","assets/sphere-7a1936d3.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-a026f34a.js","assets/Texture-501dc2a6.js","assets/VertexArrayObject-de8d8d6a.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-6b02c17b.js","assets/lengthUtils-32b5157c.js","assets/VertexElementDescriptor-2925c6af.js"]));function Gs(t){t.fragment.uniforms.add(new te("projInfo",(e,r)=>Hs(r))),t.fragment.uniforms.add(new ye("zScale",(e,r)=>uo(r))),t.fragment.code.add(s`vec3 reconstructPosition(vec2 fragCoord, float depth) {
...
return fallOffFunction(vv, vn, 0.1);
  ...
  `),t}function ho(t){return Math.max(10,20*t.computeRenderPixelSizeAtDist(Math.abs(4*t.relativeElevation)))}const oi=fi(),ks=Object.freeze(Object.defineProperty({__proto__:null,build:Ws,getRadius:ho},Symbol.toStringTag,{value:"Module"}));let js=class mo extends br{initializeProgram(e){return new Sr(e.rctx,mo.shader.get().build(),Bt)}initializePipeline(){return fr({colorWrite:pr})}};js.shader=new Ut(ks,()=>gt(()=>import("./SSAO.glsl-acd7c463.js"),["assets/SSAO.glsl-acd7c463.js","assets/index-989909ce.js","assets/index-0492b785.css","assets/OrderIndependentTransparency-309a1bc3.js","assets/enums-b14466b3.js","assets/basicInterfaces-4ab7cc6a.js","assets/VertexAttribute-9f2e53ec.js","assets/vec4f64-aa64c7e9.js","assets/devEnvironmentUtils-5002a058.js","assets/mat3f64-221ce671.js","assets/mat4f64-1413b4a7.js","assets/BufferView-d0acf3a4.js","assets/vec32-c2909e9e.js","assets/DefaultMaterial_COLOR_GAMMA-302922de.js","assets/Version-f874365f.js","assets/quat-6714c1ef.js","assets/quatf64-3363c48e.js","assets/resourceUtils-1d112ccb.js","assets/Indices-91be4389.js","assets/byteSizeEstimations-7cf1c05d.js","assets/NestedMap-1b5db22e.js","assets/requestImageUtils-074a1958.js","assets/InterleavedLayout-1faa6139.js","assets/types-1305598a.js","assets/sphere-7a1936d3.js","assets/ByteSizeUnit-d4757d40.js","assets/lineSegment-a026f34a.js","assets/Texture-501dc2a6.js","assets/VertexArrayObject-de8d8d6a.js","assets/vec3f32-ad1dc57f.js","assets/doublePrecisionUtils-e3c3d0d8.js","assets/symbolColorUtils-6b02c17b.js","assets/lengthUtils-32b5157c.js","assets/VertexElementDescriptor-2925c6af.js"]));const qs=2;function Cr(t,e){const r=t.fragment;e.receiveAmbientOcclusion?(r.uniforms.add(new Z("ssaoTex",(i,o)=>o.ssaoHelper.colorTexture)),r.constants.add("blurSizePixelsInverse","float",1/qs),r.code.add(s`float evaluateAmbientOcclusionInverse() {
