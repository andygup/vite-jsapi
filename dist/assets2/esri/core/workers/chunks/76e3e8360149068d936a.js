...
}`)}var b=r(92302),A=r(85787),E=r(93669),S=r(8319),w=r(47026);function R(e,t){const{vertex:r,fragment:d}=e,f=t.hasModelTransformation;f&&r.uniforms.add(new S.g("model",(e=>null!=e.modelTransformation?e.modelTransformation:i.I)));const g=t.hasColorTexture&&t.alphaDiscardMode!==w.JJ.Opaque;switch(t.output){case n.H.Depth:case n.H.Shadow:case n.H.ShadowHighlight:case n.H.ShadowExcludeHighlight:case n.H.ObjectAndLayerIdColor:(0,E.Sv)(r,t),e.include(s.w,t),e.include(h.D,t),e.include(b.k,t),e.include(p,t),e.include(a.f5,t),e.include(u,t),(0,o.Zu)(e),e.varyings.add("depth","float"),g&&d.uniforms.add(new v.A("tex",(e=>e.texture))),r.code.add(c.H`
          void main(void) {
            vpos = calculateVPos();
            vpos = subtractOrigin(vpos);
            vpos = addVerticalOffset(vpos, localOrigin);
